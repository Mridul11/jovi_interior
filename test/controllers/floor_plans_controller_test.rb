...
class FloorPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create floor_plan" do
    assert_difference('FloorPlan.count') do
      post floor_plans_url, params: { floor_plan: { floor_plan_image: @floor_plan.floor_plan_image, user_id: @floor_plan.user_id } }
    end
  ...
  test "should update floor_plan" do
    patch floor_plan_url(@floor_plan), params: { floor_plan: { floor_plan_image: @floor_plan.floor_plan_image, user_id: @floor_plan.user_id } }
